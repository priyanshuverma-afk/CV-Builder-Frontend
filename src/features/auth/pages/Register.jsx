            ...
            <div className="w-full max-w-sm">
                ...
                <div className="bg-[#161b22] border border-[#2a3348] rounded-2xl p-8">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        <div className="flex flex-col gap-1.5">
                            ...
                            <input
                                ...
                                type="text" id="username" name="username" placeholder="yourname"
                    ...
                    <p className="text-center text-sm text-[#7d8590] mt-6">
                        ...
                        <Link to="/login" className="text-[#ff2d78] hover:text-[#ff6b9d] font-medium transition-colors">Login</Link>
                    </p>
                </div>
            </div>
        </main>
